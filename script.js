...
//Colorscale for chart data background
	var colorscale = d3.scale.category10();
//function to fill dropdown meu with player names and id-s
...
//function to set data that need to be shown on chart
...
//function that sets data for first player and draw chart. Sets name , name in legend, data(grades),config for legend, 
//adding legend, sets info for player(nationality etc) and sets players picture
...
//function that sets config for chart
	function setConfig(){
		var mycfg = {
			w: w,
			h: h,
...
//function that return player object with given name of player(because in dropdown we access to object by their id/index)
...
//function for setting player info(beyond player picture)
...
//function for calculating player value in milions 
...
//function for setting picture with certain atributs(preferred foot and heading accuracy)
